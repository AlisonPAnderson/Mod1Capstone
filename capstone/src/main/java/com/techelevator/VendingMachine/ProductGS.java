...
import java.util.regex.Pattern;
    ...
    public class ProductGS {
        ...
        private Map<String, com.techelevator.products.Product> menu;
        private List<com.techelevator.products.Product> productsList;
        double amountRemaining = 0.00;


        public Map<String, com.techelevator.products.Product> buildMenu() throws FileNotFoundException {
            int line=0;
